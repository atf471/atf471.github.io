...
window.onload = function() {
  ...
  newTodoInput = document.getElementById("input");
}
...
function refreshTodos() {
  todoDB.fetchTodos(function(todos) {
    ...
    for(var i = 0; i < todos.length; i++) {
      ...
      //...create text and span OOH GR8 ANALOGY: "task" & "checkbox" are little presents that you put inside the "newDiv" small box, then you put the "newDiv" small box into the "todoList" big box
      var task = todo.text;
